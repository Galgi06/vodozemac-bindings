...
const bindings = require("./pkg/vodozemac_bg.cjs");

const filename = path.join(__dirname, "pkg/vodozemac_bg.wasm");
 ...
 *
 * @returns {typeof import("./pkg/vodozemac_bg.wasm", { with: { "resolution-mode": "require" } })}
 */
 ...
 *
 * @returns {Promise<typeof import("./pkg/vodozemac_bg.wasm", { with: { "resolution-mode": "require" } })>}
 */
