(() => {
  ...
  var GroupSessionVersion = Object.freeze({
    V1: 0,
    "0": "V1"
  });
  var SessionConfigVersion = Object.freeze({
    V1: 0,
    "0": "V1"
  });
  ...
  var DecryptedMessage = class _DecryptedMessage {
    static __wrap(ptr) {
      ptr = ptr >>> 0;
      const obj = Object.create(_DecryptedMessage.prototype);
      obj.__wbg_ptr = ptr;
  ...
  var EstablishedSasFinalization = typeof FinalizationRegistry === "undefined" ? { register: () => {
  }, unregister: () => {
  } } : new FinalizationRegistry((ptr) => wasm.__wbg_establishedsas_free(ptr >>> 0, 1));
  var EstablishedSas = class _EstablishedSas {
    static __wrap(ptr) {
      ptr = ptr >>> 0;
      const obj = Object.create(_EstablishedSas.prototype);
      obj.__wbg_ptr = ptr;
  ...
  var OlmMessageFinalization = typeof FinalizationRegistry === "undefined" ? { register: () => {
  }, unregister: () => {
  } } : new FinalizationRegistry((ptr) => wasm.__wbg_olmmessage_free(ptr >>> 0, 1));
  var OlmMessage = class _OlmMessage {
    static __wrap(ptr) {
      ptr = ptr >>> 0;
      const obj = Object.create(_OlmMessage.prototype);
      obj.__wbg_ptr = ptr;
  ...
  var OneTimeKeyGenerationResultFinalization = typeof FinalizationRegistry === "undefined" ? { register: () => {
  }, unregister: () => {
  } } : new FinalizationRegistry((ptr) => wasm.__wbg_onetimekeygenerationresult_free(ptr >>> 0, 1));
  var OneTimeKeyGenerationResult = class _OneTimeKeyGenerationResult {
    static __wrap(ptr) {
      ptr = ptr >>> 0;
      const obj = Object.create(_OneTimeKeyGenerationResult.prototype);
      obj.__wbg_ptr = ptr;
  ...
  var SasBytesFinalization = typeof FinalizationRegistry === "undefined" ? { register: () => {
  }, unregister: () => {
  } } : new FinalizationRegistry((ptr) => wasm.__wbg_sasbytes_free(ptr >>> 0, 1));
  var SasBytes = class _SasBytes {
    static __wrap(ptr) {
      ptr = ptr >>> 0;
      const obj = Object.create(_SasBytes.prototype);
      obj.__wbg_ptr = ptr;
