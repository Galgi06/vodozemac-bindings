...
export const __wbg_onetimekeygenerationresult_free: (a: number, b: number) => void;
export const account_create_inbound_session: (a: number, b: number, c: number, d: number) => [number, number, number];
export const account_create_outbound_session: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number];
...
export const account_generate_one_time_keys: (a: number, b: number) => number;
...
export const account_pickle_libolm: (a: number, b: number, c: number) => [number, number, number, number];
...
export const onetimekeygenerationresult_created: (a: number) => [number, number];
export const onetimekeygenerationresult_removed: (a: number) => [number, number];
export const __wbg_get_olmmessage_ciphertext: (a: number) => [number, number];
export const __wbg_get_olmmessage_message_type: (a: number) => number;
export const __wbg_olmmessage_free: (a: number, b: number) => void;
export const __wbg_session_free: (a: number, b: number) => void;
export const __wbg_set_olmmessage_ciphertext: (a: number, b: number, c: number) => void;
export const __wbg_set_olmmessage_message_type: (a: number, b: number) => void;
export const olmmessage_new: (a: number, b: number, c: number) => number;
export const session_decrypt: (a: number, b: number) => [number, number, number, number];
export const session_encrypt: (a: number, b: number, c: number) => [number, number, number];
...
export const session_session_matches: (a: number, b: number) => number;
...
export const groupsession_from_libolm_pickle: (a: number, b: number, c: number, d: number) => [number, number, number];
...
export const groupsession_new: (a: number) => number;
...
export const inboundgroupsession_import: (a: number, b: number, c: number) => [number, number, number];
export const inboundgroupsession_new: (a: number, b: number, c: number) => [number, number, number];
