...
import * as bindings from "./pkg/vodozemac_bg.js";

// @ts-ignore Safe to assume that the user is running in a environment that supports import.meta.url
const filename = fileURLToPath(new URL("./pkg/vodozemac_bg.wasm", import.meta.url));
 ...
 *
 * @returns {typeof import("./pkg/vodozemac_bg.wasm.js")}
 */
 ...
 *
 * @returns {Promise<typeof import("./pkg/vodozemac_bg.wasm.js")>}
 */
...
export * from "./pkg/vodozemac_bg.js";